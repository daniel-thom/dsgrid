...
python>=3.11, we recommend using [Conda](https://conda.io/projects/conda/en/latest/index.html) to
help manage your python packages and environments.

Steps to make a dsgrid Conda environment:

1. [Download and install Conda](https://conda.io/projects/conda/en/latest/user-guide/install) if
...
dsgrid's key dependency is [Apache Spark](https://spark.apache.org/). Apache Spark requires Java, so check if you have it.
